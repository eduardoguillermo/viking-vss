...
function stockDatalist(id, categoria){
  var opts = DB.componentes.filter(function(c){
    return c.area==='Mantenimiento'||c.area==='Ambas';
  });
  if(categoria){
...
function editarEquipo(){
  ...
  openModal('Editar equipamiento',`
    <div class="fg3">
      ...
      <div class="fg"><label>Modelo batería</label><input id="eq-bmo" value="${e.bat_modelo||''}" list="dl-eq-bmo">${stockDatalist("eq-bmo","bateria")}</div>
      <div class="fg"><label>Marca cargador</label><input id="eq-cm" value="${e.carg_marca||''}"></div>
      <div class="fg"><label>Modelo cargador</label><input id="eq-cmo" value="${e.carg_modelo||''}" list="dl-eq-cmo">${stockDatalist("eq-cmo","cargador")}</div>
      <div class="fsec">Fuente / transformador</div>
      <div class="fg"><label>Marca fuente</label><input id="eq-fm" value="${e.fuente_marca||''}"></div>
      <div class="fg"><label>Modelo fuente</label><input id="eq-fmo" value="${e.fuente_modelo||''}" list="dl-eq-fmo">${stockDatalist("eq-fmo","fuente")}</div>
      ...
      <div class="fg"><label>Modelo sirena</label><input id="eq-smo" value="${e.sirena_modelo||''}" list="dl-eq-smo">${stockDatalist("eq-smo","sirena")}</div>
