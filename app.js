...
const PANELS=['clientes','alta','detalle','versiones','tipos','backup','presupuestos','stock','catalogo','movimientos','ordenes','config','reportes','proveedores','gestion'];
  ...
  document.getElementById('cont-equipo').innerHTML=`
    ...
    <div class="twocol">
      <div>
        ...
        <div class="fgrid2">
          ${fbox('Marca UPS',e.ups_marca||'—')}${fbox('Modelo UPS',e.ups_modelo||'—')}
        </div>
      </div>
      <div>
...
function editarEquipo(){
  ...
  openModal('Editar equipamiento',`
    <div class="fg3">
      ...
      <div class="fg"><label>Marca UPS</label><input id="eq-ups-m" value="${e.ups_marca||''}"></div>
      <div class="fg"><label>Modelo UPS</label><input id="eq-ups-mo" value="${e.ups_modelo||''}"></div>
      <div class="fg" style="display:none"><label>x</label><input id="eq-cmo" value="${e.carg_modelo||''}"</div>
    ...
    e.ups_marca=document.getElementById('eq-ups-m')?document.getElementById('eq-ups-m').value:'';
    e.ups_modelo=document.getElementById('eq-ups-mo')?document.getElementById('eq-ups-mo').value:'';
