...
function defData(){
  return {
    nid:4,
    clientes:[
      {id:1,nombre:'García, Juan Carlos',lote:'Lote 42',barrio:'Villa del Parque',tel:'261 480-1234',modelo:'Comfort',version:'v2.4.1',fecha:'2024-03-15',mac:'A4:CF:12:7B:3E:01',pin:'9981',chatid:'123456789',estado:'Activo',
       equipo:{esp_serie:'ESP32-D0WD-2841',proveedor:'ElectroCom',fcompra:'2024-03-01',bat_marca:'Risttone',bat_modelo:'RT-1270',carg_marca:'Meanwell',carg_modelo:'DR-15-12',fuente_marca:'Meanwell',fuente_modelo:'LRS-35-12',fuente_tension:'12V 3A',sirena_marca:'Optex',sirena_modelo:'SX-360Z',sirena_serie:'SX360-00881',sirena_corte:'Sí',garantia:'Sí',gar_vence:'2027-03-15',ultimo_service:'2025-11-10'},
       zigbee:[
         {tipo:'Puerta',nombre:'Entrada principal',marca:'Aqara',modelo:'MCCGQ11LM',hex:'0x00158D0001A2B3C4',ubicacion:'Frente, puerta madera',obs:''},
         {tipo:'Ventana',nombre:'Ventana sala',marca:'Aqara',modelo:'MCCGQ11LM',hex:'0x00158D0002C4D5E6',ubicacion:'Living, lado sur',obs:''},
         {tipo:'Movimiento PIR',nombre:'Sensor pasillo',marca:'Sonoff',modelo:'SNZB-03',hex:'0x00158D0003E6F7A8',ubicacion:'Pasillo interno',obs:'Batería baja'},
         {tipo:'Botón',nombre:'Pánico sala',marca:'Aqara',modelo:'WXKG11LM',hex:'0x00158D0004A8B9C0',ubicacion:'Mesa ratona',obs:''}
       ],
       ota:[
         {fecha:'2026-04-10',vant:'v2.3.0',vnueva:'v2.4.1',metodo:'OTA',resultado:'Exitoso',obs:'Vía Telegram PIN'},
         {fecha:'2025-11-02',vant:'v2.2.0',vnueva:'v2.3.0',metodo:'Serial',resultado:'Fallido',obs:'Corte de luz durante el proceso'},
         {fecha:'2025-06-18',vant:'v2.1.0',vnueva:'v2.2.0',metodo:'Manual',resultado:'Exitoso',obs:'Primera actualización'}
       ],
       mant:[
         {fecha:'2026-03-10',tipo:'Correctivo',motivo:'Sin comunicación',falla:'Módulo WiFi',reparacion:'Reemplazo ESP32',garantia:'Sí',costo:'0',tecnico:'Martínez, R.',obs:'Cubierto por garantía'},
         {fecha:'2025-09-22',tipo:'Correctivo',motivo:'Sirena no activa',falla:'Conexión suelta',reparacion:'Reconexión terminal',garantia:'No',costo:'2500',tecnico:'Martínez, R.',obs:''},
         {fecha:'2024-11-18',tipo:'Configuración',motivo:'Falsa alarma',falla:'PIR mal calibrado',reparacion:'Reconfiguración zona',garantia:'No',costo:'2000',tecnico:'López, F.',obs:''}
       ]},
      {id:2,nombre:'Farmacia Nova SRL',lote:'Local 8',barrio:'Centro',tel:'261 423-9900',modelo:'Energy',version:'v2.3.0',fecha:'2024-06-01',mac:'B4:E6:2D:0A:11:22',pin:'4432',chatid:'987654321',estado:'Activo',
       ...
       zigbee:[{tipo:'Puerta',nombre:'Entrada local',marca:'Sonoff',modelo:'SNZB-04',hex:'0x00158D000A1B2C3D',ubicacion:'Frente local',obs:''}],
       ota:[{fecha:'2024-06-15',vant:'v2.2.0',vnueva:'v2.3.0',metodo:'OTA',resultado:'Exitoso',obs:''}],
       mant:[]},
      {id:3,nombre:'López, Marta',lote:'Lote 17',barrio:'Palermo',tel:'261 555-7711',modelo:'Base',version:'v2.4.1',fecha:'2026-05-10',mac:'',pin:'',chatid:'',estado:'Activo',
       equipo:{esp_serie:'',proveedor:'',fcompra:'',bat_marca:'',bat_modelo:'',carg_marca:'',carg_modelo:'',fuente_marca:'',fuente_modelo:'',fuente_tension:'',sirena_marca:'',sirena_modelo:'',sirena_serie:'',sirena_corte:'No',garantia:'No',gar_vence:'',ultimo_service:''},
       zigbee:[],ota:[],mant:[]}
    ],
    versiones:[
      {ver:'v2.4.1',tipo:'Mayor',fecha:'2026-03-01',notas:'Mejoras OTA y estabilidad'},
      {ver:'v2.3.0',tipo:'Menor',fecha:'2025-08-15',notas:'Soporte nuevos sensores'},
      {ver:'v2.2.0',tipo:'Patch',fecha:'2025-02-10',notas:'Corrección bug WiFi'},
      {ver:'v2.1.0',tipo:'Mayor',fecha:'2024-09-01',notas:'Primera versión estable'}
    ],
...
let DB;
try{ DB=JSON.parse(localStorage.getItem(SKEY)); if(!DB||!DB.clientes) DB=defData(); }
catch(e){ DB=defData(); }
...
DB.clientes.forEach(c=>{
  ...
  if(!c.mant) c.mant=[];
  c.mant.forEach(m=>{ if(!m.tipo) m.tipo='Correctivo'; });
});
...
function borrarTodo(){
  ...
  if(!confirm('⚠️ Última confirmación. ¿Estás seguro?')) return;
  localStorage.removeItem(SKEY);
  // Limpiar cache del service worker para forzar reinicio limpio
  if('caches' in window){
...
' +
    'Adjunto encontrará el presupuesto ' + num + ' correspondiente al sistema de seguridad Zpro ' + p.modelo + ' para el inmueble ubicado en ' + p.dir + (p.barrio ? ', ' + p.barrio : '') + '.

' +
    'El presupuesto tiene una validez de ' + (p.validez||15) + ' días corridos.
